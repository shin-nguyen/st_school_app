...
class _ProfilePageState extends State<ProfilePage> {
  ...
  void didChangeDependencies() {
    if (_isInit) {
      ...
      Provider.of<DashboardProgressNotifier>(context)
          .fetchAndSetDashboardProgress()
          .then((_) {
        setState(() {
          _isLoading = false;
        });
  ...
  Widget build(BuildContext context) {
    ...
    final dashboardProgresses = Provider.of<DashboardProgressNotifier>(context);
                  ...
                  child: Padding(
                    ...
                    child: Row(
                      ...
                      children: List.generate(
                          dashboardProgresses.getDashboardProgress.length,
                          (index) {
                        return Column(
                          children: [
                            Flexible(
                                ...
                                children: [
                                  ...
                                  Positioned(
                                    ...
                                    child: Container(
                                      ...
                                      height: h *
                                          (dashboardProgresses
                                              .getDashboardProgress[index]
                                              .count),
                                      decoration: BoxDecoration(
                                          gradient: LinearGradient(
                                              colors: dashboardProgresses
                                                  .getDashboardProgress[index]
                                                  .color),
                                          borderRadius:
                            ...
                            Text(
                              dashboardProgresses
                                  .getDashboardProgress[index].day,
